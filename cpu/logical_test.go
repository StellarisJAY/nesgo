...
func TestLogicalAND(t *testing.T) {
	testCases := []struct {
		...
		{"abs", []byte{LDA_IM, 0b11011, STA_ABS, 0x2, 0x1, AND_ABS, 0x2, 0x1}, 0b11011},
	}
...
func TestLogicalEOR(t *testing.T) {
	testCases := []struct {
		...
		{"abs", []byte{LDA_IM, 0b11011, STA_ABS, 0x2, 0x1, EOR_ABS, 0x2, 0x1}, 0},
	}
...
func TestLogicalOR(t *testing.T) {
	testCases := []struct {
		...
		{"abs", []byte{LDA_IM, 0b11011, LDX_IM, 0b00100, STX_ABS, 0x2, 0x1, EOR_ABS, 0x2, 0x1}, 0b11111},
	}
